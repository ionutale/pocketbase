import{f as v,h as V,H as ce,d as a,m as A,k as t,j as e,x as me,w as p,s as w,p as he,a as _e,l as P,M as c,b as pe,e as ge,i as xe,_ as ye,E as ve,$ as J,a0 as ie,a1 as Ae,u as M,z as we,a2 as m,O as de,L as y,G as ue}from"./index-Ci_bBm9A.js";import{F as Fe}from"./FieldsQueryParam-DtLH1vAK.js";var Ce=v('<span class="txt">Hide details</span> <i class="ri-arrow-up-s-line"></i>',1),ke=v('<span class="txt">Show details</span> <i class="ri-arrow-down-s-line"></i>',1),Le=v(`<p>The syntax basically follows the format <code><span class="txt-success">OPERAND</span> <span class="txt-danger">OPERATOR</span> <span class="txt-success">OPERAND</span></code>, where:</p> <ul><li><code class="txt-success">OPERAND</code> - could be any of the above field literal, string (single
