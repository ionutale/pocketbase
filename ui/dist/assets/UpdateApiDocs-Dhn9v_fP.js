import{S as Ht,i as Pt,s as Lt,V as Dt,X as de,W as Rt,h as d,d as we,t as he,a as ye,I as ee,Z as xe,_ as vt,C as Ft,$ as Bt,D as Nt,l as o,n,m as Ce,u as i,A as _,v as p,c as Te,w as k,J as ke,p as At,k as $e,o as It,H as te}from"./index-BJQbTgps.js";import{F as Et}from"./FieldsQueryParam-IlJRsdUv.js";function gt(r,e,t){const a=r.slice();return a[10]=e[t],a}function wt(r,e,t){const a=r.slice();return a[10]=e[t],a}function Ct(r,e,t){const a=r.slice();return a[15]=e[t],a}function Tt(r){let e;return{c(){e=i("p"),e.innerHTML=`<em>Note that in case of a password change all previously issued tokens for the current record
