import{p as oe,a as ce,l as v,b as A,M as n,d as e,m as f,e as le,i as re,f as D,h as ie,j as a,k as s,I as de,_ as ne,G as _,$ as j,a0 as I,u as g,w as y,A as pe,K as ue,a2 as p,s as q,O as S,x as L,L as N,y as me}from"./index-QTvxZBYq.js";var be=D("<button> </button>"),he=D("<div><!></div>"),ve=D(`<h3 class="m-b-sm"> </h3> <div class="content txt-lg m-b-sm"><p>Batch and transactional create/update/upsert/delete of multiple records in a single request.</p></div> <div class="alert alert-warning"><div class="icon"><i class="ri-error-warning-line"></i></div> <div class="content"><p>The batch Web API need to be explicitly enabled and configured from the <a href="/settings">Dashboard settings</a>.</p> <p>Because this endpoint process the requests in a single transaction it could degrade the
            ...
            allowed execution timeout, large body size limit, etc.).</p></div></div> <!> <h6 class="m-b-xs">API details</h6> <div class="api-route alert alert-success"><strong class="label label-primary">POST</strong> <div class="content">/api/batch</div></div> <div class="section-title">Body Parameters</div> <p>Body parameters could be sent as <em>application/json</em> or <em>multipart/form-data</em>. <br/> File upload is supported only via <em>multipart/form-data</em> (see below for more details).</p> <table class="table-compact table-border m-t-xs m-b-base"><thead><tr><th>Param</th><th width="80%">Description</th></tr></thead><tbody><tr><td valign="top"><div class="flex txt-nowrap"><span class="label label-success">Required</span> <span>requests</span></div></td><td><span class="label"></span> - List of the requests to process. <p>The supported batch request actions are:</p> <ul><li>record create - <code></code></li> <li>record update - <code></code></li> <li>record upsert - <code></code> <br/> <small class="txt-hint">(the body must have <code class="txt-sm">id</code> field)</small></li> <li>record delete - <code></code></li></ul> <p>Each batch Request element have the following properties:</p> <ul><li><code>url path</code> <em>(could include query parameters)</em></li> <li><code>method</code> <em>(GET, POST, PUT, PATCH, DELETE)</em></li> <li><code>headers</code> <br/> <em>(custom per-request <code>Authorization</code> header is not supported at the moment,
                    ...
                    to follow the pattern <code>requests.N.fileField</code> or <code>requests[N].fileField</code> <em>(this is usually handled transparently by the SDKs when their specific object notation
                        is used)</em>. <br/> If you don't use the SDKs or prefer manually to construct the <code>FormData</code> body, then it could look something like: <!></p></td></tr></tbody></table> <div class="section-title">Responses</div> <div class="tabs"><div class="tabs-header compact combined left"></div> <div class="tabs-content"></div></div>`,1);function _e(U,x){oe(x,!1);const u=f(),m=f();let t=ce(x,"collection",8),h=f(200),b=[];v(()=>A,()=>{q(u,S.getApiExampleUrl(A.baseURL))}),v(()=>n(t()),()=>{q(m,S.dummyCollectionRecord(t()))}),v(()=>(n(t()),e(m)),()=>{var o;(o=t())!=null&&o.id&&(b.push({code:200,body:JSON.stringify([{status:200,body:e(m)},{status:200,body:Object.assign({},e(m),{id:e(m).id+"2"})}],null,2)}),b.push({code:400,body:`
                {
                  "status": 400,
            ...
            `}),b.push({code:403,body:`
                {
                  "status": 403,
                  "message": "Batch requests are not allowed.",
                  "data": {}
                }
            `}))}),le(),re();var k=ve(),w=ie(k),H=s(w),P=a(w,4),z=a(s(P),2),K=s(z),G=a(s(K));de(G,o=>{var l;return(l=ue)==null?void 0:l(o)});var R=a(P,2);{let o=_(()=>(e(u),n(t()),p(()=>{var c,r,i,d;return`
        import PocketBase from 'pocketbase';

        const pb = new PocketBase('${e(u)}');

        ...

        const batch = pb.createBatch();

        batch.collection('${(c=t())==null?void 0:c.name}').create({ ... });
        batch.collection('${(r=t())==null?void 0:r.name}').update('RECORD_ID', { ... });
        batch.collection('${(i=t())==null?void 0:i.name}').delete('RECORD_ID');
        batch.collection('${(d=t())==null?void 0:d.name}').upsert({ ... });

        const result = await batch.send();
    `}))),l=_(()=>(e(u),n(t()),p(()=>{var c,r,i,d;return`
        import 'package:pocketbase/pocketbase.dart';

        final pb = PocketBase('${e(u)}');

        ...

        final batch = pb.createBatch();

        batch.collection('${(c=t())==null?void 0:c.name}').create(body: { ... });
        batch.collection('${(r=t())==null?void 0:r.name}').update('RECORD_ID', body: { ... });
        batch.collection('${(i=t())==null?void 0:i.name}').delete('RECORD_ID');
        batch.collection('${(d=t())==null?void 0:d.name}').upsert(body: { ... });

        final result = await batch.send();
    `})));ne(R,{get js(){return e(o)},get dart(){return e(l)}})}var B=a(R,10),J=a(s(B)),M=s(J),W=a(s(M)),C=s(W);C.textContent="Array<Request>";var T=a(C,4),$=s(T),Q=a(s($));Q.textContent="POST /api/collections/{collection}/records";var E=a($,2),V=a(s(E));V.textContent="PATCH /api/collections/{collection}/records/{id}";var F=a(E,2),X=a(s(F));X.textContent="PUT /api/collections/{collection}/records";var Y=a(F,2),Z=a(s(Y));Z.textContent="DELETE /api/collections/{collection}/records/{id}";var ee=a(T,6),te=a(s(ee),16);{let o=_(()=>(n(t()),p(()=>`
                        ...
                        `)));j(te,{language:"javascript",get content(){return e(o)}})}var ae=a(B,4),O=s(ae);I(O,5,()=>b,o=>o.code,(o,l)=>{var c=be();let r;var i=s(c);g(d=>{r=L(c,1,"tab-item",null,r,d),N(i,(e(l),p(()=>e(l).code)))},[()=>({active:e(h)===e(l).code})]),me("click",c,()=>q(h,e(l).code)),y(o,c)});var se=a(O,2);I(se,5,()=>b,o=>o.code,(o,l)=>{var c=he();let r;var i=s(c);j(i,{get content(){return e(l),p(()=>e(l).body)}}),g(d=>r=L(c,1,"tab-item",null,r,d),[()=>({active:e(h)===e(l).code})]),y(o,c)}),g(()=>N(H,`Batch create/update/upsert/delete (${n(t()),p(()=>t().name)??""})`)),y(U,k),pe()}export{_e as default};
