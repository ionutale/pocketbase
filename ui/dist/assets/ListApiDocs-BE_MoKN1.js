import{f as u,h as W,H as pe,d as a,m as y,k as t,j as e,y as he,w as v,s as A,p as be,a as _e,l as S,M as p,b as ve,e as ge,i as xe,_ as we,G as ue,$ as M,a0 as de,a1 as ye,u as V,A as Ae,a2 as h,O as ce,L as w,x as fe}from"./index-C9Y1y-Co.js";import{F as Fe}from"./FieldsQueryParam-yjG8U_VT.js";var Ce=u('<span class="txt">Hide details</span> <i class="ri-arrow-up-s-line"></i>',1),ke=u('<span class="txt">Show details</span> <i class="ri-arrow-down-s-line"></i>',1),Le=u(`<p>The syntax basically follows the format <code><span class="txt-success">OPERAND</span> <span class="txt-danger">OPERATOR</span> <span class="txt-success">OPERAND</span></code>, where:</p> <ul><li><code class="txt-success">OPERAND</code> - could be any of the above field literal, string (single
