import{f as v,h as W,H as pe,d as a,m as y,k as t,j as e,y as he,w as p,s as A,p as be,a as _e,l as S,M as c,b as ve,e as ge,i as xe,_ as we,G as ue,$ as M,a0 as de,a1 as ye,u as V,A as Ae,a2 as f,O as ce,L as w,x as fe}from"./index-pugPOFvJ.js";import{F as Fe}from"./FieldsQueryParam-C48ggtUf.js";var Ce=v('<span class="txt">Hide details</span> <i class="ri-arrow-up-s-line"></i>',1),ke=v('<span class="txt">Show details</span> <i class="ri-arrow-down-s-line"></i>',1),Le=v(`<p>The syntax basically follows the format <code><span class="txt-success">OPERAND</span> <span class="txt-danger">OPERATOR</span> <span class="txt-success">OPERAND</span></code>, where:</p> <ul><li><code class="txt-success">OPERAND</code> - could be any of the above field literal, string (single
