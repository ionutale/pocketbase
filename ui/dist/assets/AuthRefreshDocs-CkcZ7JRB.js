import{p as I,a as W,l as O,b as $,M as n,e as X,i as Y,f as y,h as Z,j as a,_ as ee,d as e,G as q,k as s,$ as B,a0 as C,m as v,u as m,w as f,A as te,a2 as l,s as g,O as D,x as E,L as _,y as ae}from"./index-C9Y1y-Co.js";import{F as se}from"./FieldsQueryParam-yjG8U_VT.js";var oe=y("<button> </button>"),re=y("<div><!></div>"),de=y(`<h3 class="m-b-sm"> </h3> <div class="content txt-lg m-b-sm"><p>Returns a new auth response (token and record data) for an <strong>already authenticated record</strong>.</p> <p>This method is usually called by users on page/screen reload to ensure that the previously stored data
